	...
	<div class="container">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="memberlist.jsp">회원목록</a></li>
		...
		<form action="${pageContext.request.contextPath }/guest/insert.jsp" method="post">
			...
			<div class="form-floating mb-3">
				<textarea class= "form-control" palceholder="내용 입력..." style="hegiht:200px;" name="content" id="conten" cols="30" rows="10"></textarea>
				<label for="content">내용</label>
			</div>
			<div class="form-floating mb-3">
				<input class="form-control" placholder="비밀번호 입력..." type="password" id="pwd" name='pwd' />
