...
<body>
	<%--
	 ...
	 <jsp:include page="webapp 내에서의 jsp 페이지 경로">
	 	...
	 	- include 를 시킬때 include 될 jsp 페이지에 파라미터를 전달 할 수도 있다.
	...
	<div class="container">
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/member/memberlist.jsp">회원목록 보기</a></li>
