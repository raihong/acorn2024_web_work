		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav">
				<%if(currentPage.equals("index")){ %>
					<li class="nav-item">
						<a class="nav-link <%=currentPage.equals("member")? "active" :"" %>" href="${pageContext.request.contextPath }/member/memberlist.jsp">회원목록</a>
					</li>
					<li class="nav-item">
				...
				<%}else if(currentPage.equals("member")){ %>
					<li class="nav-item">
						<a class="nav-link active" href="${pageContext.request.contextPath }/member/memberlist.jsp">회원목록</a>
					</li>
					<li class="nav-item">
				...
				<%}else if(currentPage.equals("guest")){ %>
					<li class="nav-item">
						<a class="nav-link" href="${pageContext.request.contextPath }/member/memberlist.jsp">회원목록</a>
					</li>
					<li class="nav-item">
